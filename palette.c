...
byte v_pal_getcolor=0;
void FUX0R_PAL(void) {
memset(palmap,0,32768*sizeof(byte));
memset(pallock,0,256*sizeof(byte));
memset(palrev,0,256*sizeof(int));

memset(crsmap,0,4*32768*sizeof(byte));
memset(crsmap,0,4*256*sizeof(int));
v_pal_getcolor=0;
}
...
{
	byte n;
/*     static byte l=0;*/byte l=v_pal_getcolor; //gp32hack
